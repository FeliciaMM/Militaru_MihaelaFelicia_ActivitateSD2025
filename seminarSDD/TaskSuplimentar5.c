...
//}
//
//Masina* salvareMasiniVector(Nod* cap, float pretCon, int* dimensiune) {
//	int numar = 0;
//	Nod* temp = cap;
//	while (temp) {
//		if (temp->info.pret > pretCon) {
//			numar++;
//		}
//		temp = temp->next;
//	}
//
//	Masina* vector = (Masina*)malloc(numar * sizeof(Masina));
//	if (!vector) {
//		return NULL;
//	}
//	temp = cap;
...
//	int dimensiune;
//
//	printf("Masini vector conditionat, cu pret mai mare de 5000:\n");
//
//	Masina* vectorConditionat = salvareMasiniVector(cap, 5000, &dimensiune);
//	for (int i = 0; i < dimensiune; i++) {
//		afisareMasina(vectorConditionat[i]);
//	}
//
