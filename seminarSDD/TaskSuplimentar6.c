...
//}
//
//void parcurgereListaCrescator(List lista) {
//	Nod* temp = lista.first;
//	while (temp) {
//		printf("Id: %d\n", temp->info.id);
//		printf("nrUsi: %d\n", temp->info.nrUsi);
...
//}
//
//void parcurgereListaDescrescator(List lista) {
//	Nod* temp = lista.last;
//	while (temp) {
//		printf("Id: %d\n", temp->info.id);
//		printf("nrUsi: %d\n", temp->info.nrUsi);
...
//	printf("Parcurgerea listei crescator:\n");
//	parcurgereListaCrescator(list);
//	printf("Parcurgerea listei descrescator:\n");
//	parcurgereListaDescrescator(list);
//	stergeUnNod(&list, 2);
